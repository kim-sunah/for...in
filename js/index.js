...
const search_word = new URL(document.location.href).searchParams.get(
  "searchWord"
);
    ...
    const promise = fetch(
      ...
      .then((response) => {
        response.results.forEach((element) => {
          ...
          const movieAverage = Math.floor(element.vote_average * 10) / 10;
      ...
      .catch((err) =>
        alert("데이터 정보를 불러오지 못했습니다. 에러 : " + err)
      );
